...
const routes = [
  ...
  { path: '/master/users', name: 'users', component: Users, meta: { roles: ['admin', 'manager'] } },
  ...
  { path: '/settings/system', name: 'settings-system', component: SystemSettings, meta: { roles: ['admin'] } },
  { path: '/settings/backup', name: 'settings-backup', component: BackupSettings, meta: { roles: ['admin', 'manager'] } }
];
