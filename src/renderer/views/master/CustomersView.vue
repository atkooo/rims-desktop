    ...
    <div class="data-page">
        <div class="page-header">
            <div>
                ...
                <p class="subtitle">Informasi pelanggan dari database tanpa aksi CRUD.</p>
            </div>
    ...
    setup() {
        ...
        const columns = [
            ...
            },
            {
                key: 'created_at',
                label: 'Dibuat',
                format: (value) => (value ? new Date(value).toLocaleDateString('id-ID') : '-')
            }
        ]

        const stats = computed(() => {
            const totalCustomers = customers.value.length
            const activeCustomers = customers.value.filter((customer) => customer.is_active).length
            ...
            return { totalCustomers, activeCustomers, totalTransactions, avgTransactions }
        })
