    ...
    <div class="reports-page">
        ...
        <div class="filters-section">
            <div class="filter-group">
                <FormInput id="startDate" label="Tanggal Mulai" type="date" v-model="filters.startDate" />
                <FormInput id="endDate" label="Tanggal Akhir" type="date" v-model="filters.endDate" />
        ...
        <div v-if="hasData" class="summary-section">
            <div class="summary-cards">
                ...
                <div class="summary-card">
                    <h3>Item Terlaris</h3>
                    <div class="top-items">
                        <div v-for="item in summary.topItems" :key="item.id" class="top-item">
                            <span>{{ item.name }}</span>
            ...
            <div class="details-section">
                <div class="tabs">
                    <div v-for="tab in tabs" :key="tab.id" class="tab" :class="{ active: currentTab === tab.id }"
                ...
                <div v-if="currentTab === 'transactions'" class="tab-content">
                    <DataTable :columns="transactionColumns" :items="reportData.transactions" :loading="loading" />
                </div>

                <!-- Items Performance -->
                <div v-if="currentTab === 'items'" class="tab-content">
                    <DataTable :columns="itemColumns" :items="reportData.items" :loading="loading" />
                </div>
        ...
        <div v-else-if="!loading" class="no-data">
            <p>Pilih rentang tanggal dan klik Generate Report untuk melihat laporan</p>
        </div>
    </div>
</template>
        ...
        const generateReport = async () => {
            ...
            try {
                ...
                summary.value = {
                    ...
                    rentalIncome: rentalTransactions.reduce((sum, t) => sum + t.totalAmount, 0),
                    salesIncome: salesTransactions.reduce((sum, t) => sum + t.totalAmount, 0),
