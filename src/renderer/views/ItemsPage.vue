<template>
    <div class="items-page">
        <div class="page-header">
            ...
            <!-- Filters -->
            <div class="filters">
                <FormInput id="searchItem" v-model="filters.search" placeholder="Cari item..." class="search-input" />
        ...
        <!-- Items Table -->
        <DataTable :columns="columns" :items="filteredItems" :loading="loading" actions @edit="handleEdit"
            @delete="handleDelete">
        ...
        <!-- Item Form Dialog -->
        <ItemForm v-model="showForm" :edit-data="editingItem" @saved="handleSaved" />
...
export default {
    ...
    setup() {
        ...
        const itemsAvailable = computed(() =>
            filteredItems.value.filter(item => item.status === 'AVAILABLE').length
        )
