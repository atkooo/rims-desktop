<template>
    <div class="settings-page">
        ...
        <div class="settings-container">
            ...
            <div class="settings-section">
                ...
                <div class="form-group">
                    <FormInput id="companyName" label="Nama Toko" v-model="settings.companyName"
                        :error="errors.companyName" />
                    <FormInput id="address" label="Alamat" type="textarea" v-model="settings.address" />
                    <FormInput id="phone" label="Nomor Telepon" v-model="settings.phone" :error="errors.phone" />
                </div>
                <AppButton variant="primary" :loading="loading" @click="saveCompanyProfile">
                    Simpan Profil
                </AppButton>
            </div>
            ...
            <div class="settings-section">
                ...
                <div class="backup-info">
                    ...
                    <div class="backup-actions">
                        <AppButton variant="primary" :loading="backupLoading" @click="createBackup">
                            Backup Sekarang
                        </AppButton>
                        <AppButton variant="secondary" :loading="restoreLoading" @click="showRestoreDialog = true">
                            Restore Backup
                        </AppButton>
                    </div>
                </div>
            ...
            <div class="settings-section">
                ...
                <div class="form-group">
                    <div class="form-row">
                        ...
                        <FormInput id="paperWidth" label="Lebar Kertas (mm)" type="number"
                ...
                <AppButton variant="primary" :loading="loading" @click="savePrinterSettings">
                    Simpan Pengaturan
                </AppButton>
            </div>
        </div>
        ...
        <AppDialog v-model="showRestoreDialog" title="Restore Backup" confirm-text="Restore" :loading="restoreLoading"
