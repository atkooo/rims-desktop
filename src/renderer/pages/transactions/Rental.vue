<template>
  <div class="page">
    ...
    <div class="totals">
      ...
      <div>Deposit: <NumberInput v-model="deposit" /></div>
...
.totals { display:flex; gap:16px; align-items:center; justify-content:flex-end; padding:16px 0; margin-top: 16px; border-top: 1px solid var(--border); }
