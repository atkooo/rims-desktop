    ...
    <div class="table-container">
                ...
                <tr v-for="item in items" :key="item.id">
                    ...
                    <td v-if="actions" class="actions">
                        <slot name="actions" :item="item">
                            <AppButton v-if="showEdit" variant="secondary" class="action-button"
                                @click="$emit('edit', item)">
                                Edit
                            </AppButton>
                            <AppButton v-if="showDelete" variant="danger" class="action-button"
        ...
        <div v-if="pagination" class="pagination">
            ...
            <div class="pagination-buttons">
                <AppButton variant="secondary" :disabled="currentPage === 1"
