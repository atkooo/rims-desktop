...
.dropdown { position:absolute; z-index:20; background:#ffffff; border:1px solid var(--border); border-radius:8px; margin-top:6px; width:100%; max-height:220px; overflow:auto; box-shadow: 0 10px 30px rgba(15,23,42,.12); }
.dropdown li { padding:8px 10px; cursor:pointer; }
.dropdown li:hover { background:#f1f5f9; }
.dropdown .empty { color:#94a3b8; cursor: default; }
</style>
