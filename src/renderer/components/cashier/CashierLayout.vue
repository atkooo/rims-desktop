...
export default {
  ...
  setup() {
    ...
    const navItems = [
      ...
      { path: "/cashier/sale", icon: "dollar-sign", label: "Penjualan" },
      { path: "/cashier/rental", icon: "package", label: "Rental" },
      { path: "/cashier/transactions/sales", icon: "shopping-cart", label: "Transaksi Penjualan" },
      { path: "/cashier/transactions/rentals", icon: "calendar", label: "Transaksi Rental" },
