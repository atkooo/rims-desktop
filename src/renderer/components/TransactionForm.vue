<template>
    <AppDialog v-model="showDialog" :title="isEdit ? 'Edit Transaksi' : 'Transaksi Baru'"
        :confirm-text="isEdit ? 'Update' : 'Simpan'" :loading="loading" @confirm="handleSubmit">
        <form @submit.prevent="handleSubmit" class="transaction-form">
            <!-- Customer Info -->
            <div class="form-section">
                <h3>Informasi Customer</h3>
                <FormInput id="customerName" label="Nama Customer" v-model="form.customerName"
    ...
    setup(props, { emit }) {
        ...
        const handleSubmit = async () => {
            ...
            try {
                ...
                if (isEdit.value) {
                    await transactionStore.updateTransaction(props.editData.id, transactionData)
                } else {
