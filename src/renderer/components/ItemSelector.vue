<template>
    <div class="item-selector">
        <div class="search-bar">
            <input type="text" v-model="search" placeholder="Cari item..." class="search-input" />
            <div v-if="filteredItems.length" class="items-dropdown">
                <div v-for="item in filteredItems" :key="item.id" class="item-option"
                    :class="{ 'unavailable': item.status !== 'AVAILABLE' }" @click="selectItem(item)">
                    <div>
        ...
        <div class="selected-items">
            <div v-for="(item, index) in selectedItems" :key="item.id" class="selected-item">
                ...
                <div class="item-actions">
                    ...
                    <AppButton variant="danger" class="remove-button" @click="removeItem(index)">
                        &times;
                    </AppButton>
                </div>
            </div>
