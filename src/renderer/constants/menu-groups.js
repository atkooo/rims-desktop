export const menuGroups = [
  {
    title: "Transaksi",
    items: [
      { to: "/transactions/rentals", label: "Sewa & Pengembalian", icon: "key" },
      { to: "/transactions/sales", label: "Penjualan Toko", icon: "shopping-bag" },
      { to: "/transactions/bookings", label: "Booking Jadwal", icon: "calendar" },
      { to: "/transactions/payments", label: "Pembayaran & Invoice", icon: "credit-card" },
    ],
  },
  {
    title: "Stok & Gudang",
    items: [
      { to: "/transactions/stock-movements", label: "Pergerakan Stok", icon: "layers" },
